...
/**
 * Selenium тест для страницы входа: успешный логин.
 */
@SpringBootTest(
...
public class LoginPageTest {
    ...
    /**
     * Создание пользователя с правами администратора перед каждым тестом.
     */
    @BeforeEach
    ...
    public void successfulLogin() {
        ...
        assertTrue((body != null) && (
                body.contains("Logout") || body.contains("Выход") ||
